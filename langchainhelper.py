...
def generate_restaurant_name_and_items(cuisine):
    ...
    prompt_template_items = PromptTemplate(
        ...
        template="Suggest some menu items for {restaurant_name}. Return the items as a comma-separated string."
    )

    food_chain_items = LLMChain(llm=llm, prompt=prompt_template_items, output_key="menu_items")
